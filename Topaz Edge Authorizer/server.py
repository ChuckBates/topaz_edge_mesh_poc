...
from directory.directory_connection import DirectoryConnection
...
topaz_authorizer_url = config["topaz_authorizer_host"] + ":" + config["topaz_authorizer_port"]
topaz_directory_url = config["topaz_directory_host"] + ":" + config["topaz_directory_port"]

directory_connection = DirectoryConnection(topaz_directory_url)
...
def api_check_nominations():
    ...
    url = topaz_authorizer_url + '/api/v2/authz/is'
    body = {
        "identity_context": {
            "identity": "bob",
...
def invoke_search(input, unknown):
    url = topaz_authorizer_url + '/api/v2/authz/compile'
    body = {
        "identity_context": {
