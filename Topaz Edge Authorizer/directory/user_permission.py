...
class UserPermission:
    ...
    def create_user_permission(self, company, subscriber, locations, product_types, role):
        ...
        # Relation.set_relation("user_permission", user_permission["id"], "member", "user", user_id)
        # create company relation
        self.relation.set_relation("company", company, "member", "user_permission", user_permission["id"])
        # create subscriber relation
        self.relation.set_relation("subscriber", subscriber, "member", "user_permission", user_permission["id"])
        # create locations relations
        for location in locations:
            self.relation.set_relation("location", location, "member", "user_permission", user_permission["id"])
        # create product_types relations
        for product_type in product_types:
            self.relation.set_relation("product_type", product_type, "member", "user_permission", user_permission["id"])
        # create role relation
        self.relation.set_relation("role", role, "member", "user_permission", user_permission["id"])
    ...
    def grant_user_permission(self, user_id, user_permission_id):
        ...
        # create user relation
        self.relation.set_relation("user_permission", user_permission["id"], "member", "user", user["id"])
