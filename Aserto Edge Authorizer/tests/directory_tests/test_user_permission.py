...
def test_create_user_permission(mocker):
    ...
    mock_user_permission_return = type('', (object,), {'id': user_permission_id})()
    ...
    mock_relation.create_relation.assert_any_call("company", company, "member", "user_permission", mock_user_permission_return.id)
    mock_relation.create_relation.assert_any_call("subscriber", subscriber, "member", "user_permission", mock_user_permission_return.id)
    mock_relation.create_relation.assert_any_call("location", "location1", "member", "user_permission", mock_user_permission_return.id)
    mock_relation.create_relation.assert_any_call("location", "location2", "member", "user_permission", mock_user_permission_return.id)
    mock_relation.create_relation.assert_any_call("product_type", "product_type1", "member", "user_permission", mock_user_permission_return.id)
    mock_relation.create_relation.assert_any_call("product_type", "product_type2", "member", "user_permission", mock_user_permission_return.id)
    mock_relation.create_relation.assert_any_call("role", role, "member", "user_permission", mock_user_permission_return.id)
...
def test_grant_user_permission(mocker):
    ...
    mock_user_permission_return = type('', (object,), {'id': user_permission_id})()
    mock_user_return = type('', (object,), {'id': user_id})()
    mock_directory_connection = mocker.Mock()
    mock_directory_connection.get_object.side_effect = [
        mock_user_permission_return,
        mock_user_return
    ...
    mock_relation.create_relation.assert_called_once_with("user_permission", user_permission_id, "member", "user", user_id)
