...
def test_create_user(mocker):
    ...
    mock_email_identity_return = type('', (object,), {'id': email})()
    mock_pid_identity_return = type('', (object,), {'id': "local|pid"})()
    ...
    mock_relation.create_relation.return_value = {}
    ...
    mock_relation.create_relation.assert_any_call("identity", email, "identifier", "user", user_id)
    mock_relation.create_relation.assert_any_call("identity", 'local|pid', "identifier", "user", user_id)
...
def test_delete_user_and_the_user_is_found(mocker):
    ...
    mock_user_return = type('', (object,), {'id': user_id})()
    mock_identity_relation = type('', (object,), {'id': "identity_id", 'type': "identity"})()
    mock_identity_relations = type('', (object,), {'objects': [mock_identity_relation]})()
    ...
    mock_directory_connection.delete_object.assert_any_call(
        object_type="identity",
        object_id=mock_identity_relation.id,
