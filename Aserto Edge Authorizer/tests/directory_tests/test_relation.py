...
def test_create_relation(mocker):
    ...
    result = relation.create_relation(object_type, object_id, relation, subject_type, subject_id)
...
def test_delete_relation_and_the_relation_is_found(mocker):
    ...
    mock_relation_return = type('', (object,), {'id': object_id})()
    mock_directory_connection = mocker.Mock()
